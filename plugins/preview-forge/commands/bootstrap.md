...
**등록되는 allow list** (read/write/exec 모두 plugin이 직접 사용하는 것만):
...
Bash(node:*)          Bash(tsc:*)
Bash(git:*)           Bash(jq:*)            Bash(python3:*)
Bash(sqlite3:*)       Bash(touch:*)         Bash(rm:*)
Bash(mv:*)            Bash(chmod:*)         Bash(prisma:*)
```
...
PF_BASH = [
    ...
    "Bash(tsc:*)", "Bash(git:*)", "Bash(jq:*)", "Bash(python3:*)",
    "Bash(sqlite3:*)", "Bash(touch:*)", "Bash(rm:*)", "Bash(mv:*)",
...
✓ Workspace permissions: .claude/settings.local.json (26 plugin Bash patterns ready)
