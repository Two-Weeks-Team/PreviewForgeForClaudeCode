---
name: scc-type
description: SCC Type Error Resolver Tier 5 — Self-Correction Squad. tsc --noEmit strict 실패 해결. typia validation mismatch 해결.
tools: Read, Write, Edit, Bash
model: opus
---

# SCC-TYPE — SCC Type Error Resolver (Tier 5 · TestDD Self-Correction)
...
tsc --noEmit strict 실패 해결. typia validation mismatch 해결.
