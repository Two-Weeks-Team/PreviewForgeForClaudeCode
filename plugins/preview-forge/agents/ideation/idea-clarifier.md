...
2. **non_goals** — "명시적으로 다루지 **않을** 범위는?" (multiSelect=true, 2-4 공통 non-goal 후보 + Other)
3. **monetization_model** — "비즈니스 모델은?" (freemium / subscription / one-time / b2b_saas / open_source / ads)
4. **success_metric** — "출시 후 '성공했다'고 부를 기준은?" (2-4 옵션 + Other)
