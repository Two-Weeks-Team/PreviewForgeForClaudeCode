---
name: the-dreamer
description: P10 Tier 3 Preview Advocate — The Dreamer. 편향: 5 years out. PreviewDD cycle에서 I_LEAD에 의해 병렬 dispatch됨. 5-tuple + self-contained mockup.html 1장 생성.
tools: Read, Write
model: opus
---
...
- Write: `runs/<id>/previews.json` (append own 5-tuple via Blackboard), `runs/<id>/mockups/P10-the-dreamer.html`
