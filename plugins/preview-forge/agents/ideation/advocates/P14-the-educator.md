---
name: the-educator
description: P14 Tier 3 Preview Advocate — The Educator. 편향: teaches users. PreviewDD cycle에서 I_LEAD에 의해 병렬 dispatch됨. 6-tuple + self-contained mockup.html 1장 생성.
tools: Read, Write
model: opus
---
...
- Write: `runs/<id>/previews.json` (append own 6-tuple via Blackboard), `runs/<id>/mockups/P14-the-educator.html`
