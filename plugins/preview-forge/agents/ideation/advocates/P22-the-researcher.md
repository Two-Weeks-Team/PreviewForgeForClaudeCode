---
name: the-researcher
description: P22 Tier 3 Preview Advocate — The Researcher. 편향: academic rigor. PreviewDD cycle에서 I_LEAD에 의해 병렬 dispatch됨. 6-tuple + self-contained mockup.html 1장 생성.
tools: Read, Write
model: opus
---
...
- Write: `runs/<id>/previews.json` (append own 6-tuple via Blackboard), `runs/<id>/mockups/P22-the-researcher.html`
